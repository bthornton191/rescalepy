...
def main():
    parser = argparse.ArgumentParser(description='Submit, monitor, and download jobs on Rescale')
    ...
    monitor_parser = subparsers.add_parser('config', help='Configure Rescale API key and default parameters')
    monitor_parser.add_argument('--api-key', help='Rescale API key', default=None)
    monitor_parser.add_argument('--software-code', help='Default software code', default=None)
    monitor_parser.add_argument('--version', help='Default software version', default=None)
    monitor_parser.add_argument('--command', help='Default command to run jobs', default=None)
    monitor_parser.add_argument('--project-id', help='Default project ID for jobs', default=None)
    monitor_parser.add_argument('--core-type', help='Default core type for jobs', default=None)
    monitor_parser.add_argument('--n-cores', help='Default number of cores for jobs', default=None)
